...
import { Page } from '../../components/pages/QA/All/Page'
...
const All: NextPageWithLayout<Props> = ({ questions }) => <Page questions={questions} />

All.getLayout = (page) => <Layout pageName="Q&A一覧">{page}</Layout>
