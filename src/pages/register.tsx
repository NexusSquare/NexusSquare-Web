    ...
    return (
        <Layout pageName="ユーザー登録">
            <VStack paddingTop="70px" w="100%" spacing="20px">
                <Button margin="10px 2% 0px" alignSelf="start" bgColor="#FF9037" color="white">
                    戻る
                </Button>
                <Text fontSize="4xl" fontWeight="semibold" bgColor="#FFAF82" color="white" w="100%" textAlign="center">
                    ユーザー登録
                </Text>
                        ...
                        <Input
                            ...
                            {...register('mail', {
                                ...
                                pattern: {
                                    ...
                                    message: '県大のメールアドレスを入力してください',
                                },
                            })}
                            placeholder="県大のメールアドレスを入力"
                            type="email"
                        />
