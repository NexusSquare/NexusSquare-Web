    ...
    const bodyList: JSX.Element[] = [
        ...
        <>
            <VStack spacing={2} align="left" w="full">
                <UnorderedList pl="5" spacing={3}>
                    ...
                    <ListItem fontSize="lg">当団体のサービスの運営を妨害するおそれのある行為</ListItem>
        ...
        <>
            ...
            <UnorderedList pl="5" spacing={3}>
                ...
                <ListItem fontSize="lg">その他，当団体が本サービスの提供が困難と判断した場合</ListItem>
        ...
        <>
            ...
            <Text fontSize="lg">
                前項ただし書に定める場合であっても，当団体は，当団体の過失（重過失を除きます。）による債務不履行または不法行為によりユーザーに生じた損害のうち特別な事情から生じた損害（当団体またはユーザーが損害発生につき予見し，または予見し得た場合を含みます。）について一切の責任を負いません。
            </Text>
