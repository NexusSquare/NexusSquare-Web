    ...
    const bodyList: JSX.Element[] = [
        ...
        <>
            ...
            <UnorderedList pl="5" spacing={3}>
                ...
                <ListItem>その他，当団体が利用登録を相当でないと判断した場合</ListItem>
            </UnorderedList>
        </>,
        <>
            <UnorderedList pl="5" spacing={3}>
        ...
        <>
            <VStack spacing={2} align="left" w="full">
                <UnorderedList pl="5" spacing={3}>
                    ...
                    <ListItem>当団体のサービスの運営を妨害するおそれのある行為</ListItem>
                    ...
                    <ListItem>当団体が許諾しない本サービス上での宣伝，広告，勧誘，または営業行為</ListItem>
                    <ListItem>面識のない異性との出会いを目的とした行為</ListItem>
                    <ListItem>
                        当団体のサービスに関連して，反社会的勢力に対して直接または間接に利益を供与する行為
                    </ListItem>
                    <ListItem> 他人を不快にさせるもの、誰かを著しく傷つけたり、攻撃したりするような投稿</ListItem>
                    <ListItem>学生生活に直接関わりのない、深刻な内容の投稿</ListItem>
                    <ListItem>その他，当団体が不適切と判断する行為</ListItem>
                </UnorderedList>
            </VStack>
        </>,
        <>
            ...
            <UnorderedList pl="5" spacing={3}>
                ...
                <ListItem>その他，当団体が本サービスの提供が困難と判断した場合</ListItem>
        ...
        <>
            <Text>ユーザーは，当団体の定める退会手続により，本サービスから退会できるものとします。</Text>
        </>,
        <>
            <Text></Text>
