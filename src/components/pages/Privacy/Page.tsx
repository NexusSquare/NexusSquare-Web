            ...
            <VStack spacing={10} h="full" bgColor="White" px={{ base: '10', md: '20' }} py="10" borderRadius="40">
                ...
                <VStack align="left" w="full">
                    ...
                    <VStack spacing={2} align="left" w="full">
                        ...
                        <OrderedList pl="5">
                            <ListItem fontSize="md"> 氏名</ListItem>
                            <ListItem fontSize="md"> 学校用メールアドレス</ListItem>
                            <ListItem fontSize="md"> アカウントのプロフィールとして任意にアップロードした写真</ListItem>
                ...
                <VStack align="left" w="full">
                    ...
                    <Text fontSize="md">本サービスのユーザ情報の利用目的といたしましては、以下のとおりです。</Text>
                    <Text fontSize="md">(1)本サービスにおける本人確認のため。</Text>
                    <Text fontSize="md">
                        (2)本サービスが行うキャンペーンなどで当選した商品を利用者様にお届けするため。
                    </Text>
                    <Text fontSize="md">(3)本サービスの運営に関わるお知らせを送信するため。</Text>
                </VStack>
                ...
                <VStack align="left" w="full">
                    ...
                    <VStack spacing={2} align="left" w="full">
                        <OrderedList pl="1">
                            <ListItem fontSize="md">法令に基づく場合</ListItem>
                            <ListItem fontSize="md">
