...
interface Props {
    ...
    updateNotification: (notificationId: string, questionId: string) => void
}

export const NotificationPopover: FC<Props> = ({ notifications, updateNotification }) => {
    const onClickNotification = async (notificationId: string, questionId: string) => {
        updateNotification(notificationId, questionId)
    }
    return (
        <Popover>
            <PopoverTrigger>
